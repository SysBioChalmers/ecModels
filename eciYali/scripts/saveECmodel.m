...
if strcmp(toolbox,'COBRA')
    ...
    % Remove compartment redundancy in metabolite ids:
    for i = 1:length(model_cobra.comps)
        comp = model_cobra.comps{i};
        model_cobra.mets = strrep(model_cobra.mets,['_' comp '[' comp ']'],['[' comp ']']);
    end
