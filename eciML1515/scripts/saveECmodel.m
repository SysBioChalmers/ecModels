...
if strcmp(toolbox,'COBRA')
    ...
    model_cobra = removeField(model_cobra,'metCharges');
    model_cobra = removeField(model_cobra,'metChEBIID');
    model_cobra = removeField(model_cobra,'metKEGGID');
    model_cobra = removeField(model_cobra,'metSBOTerms');
    model_cobra = removeField(model_cobra,'rxnConfidenceScores');
    model_cobra = removeField(model_cobra,'rxnECNumbers');
    model_cobra = removeField(model_cobra,'rxnKEGGID');
    model_cobra = removeField(model_cobra,'rxnReferences');
    model_cobra = removeField(model_cobra,'subSystems');
    model_cobra = removeField(model_cobra,'rxnSBOTerms');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function model = removeField(model,field)
